...
const Settings = () => {
  ...
  return (
    <>
        ...
        >
          <Stack p={4} spacing={5}>
            ...
            <Stack direction={'row'} spacing={3}>
              ...
              <Stack spacing={0.5}>
                <Typography variant="article">Ali Azhar</Typography>
                <Typography variant="body2">Save The Best For Last!</Typography>
              </Stack>
            </Stack>
            {/* List of Options */}
            <Stack spacing={4}>
      ...
      {openShorcuts && <Shorcuts open={openShorcuts} handleClose={handleCloseShortcuts} />}
    </>
  );
};
